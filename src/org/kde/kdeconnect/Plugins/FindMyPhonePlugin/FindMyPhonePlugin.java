...
public class FindMyPhonePlugin extends Plugin {
    ...
    public String getPluginName() {
        return "plugin_findmyphone";
    }

    @Override
    public String getDisplayName() {
        return context.getResources().getString(R.string.pref_plugin_findmyphone);
    }

    @Override
    public String getDescription() {
        return context.getResources().getString(R.string.pref_plugin_findmyphone_desc);
    }
    ...
    public boolean onPackageReceived(NetworkPackage np) {
        ...
        //Log.e("FindMyPhonePackageReceiver", "onPackageReceived");
        if (np.getType().equals(NetworkPackage.PACKAGE_TYPE_FINDMYPHONE)) {
            //Log.e("FindMyPhonePackageReceiver", "was a ping!");
