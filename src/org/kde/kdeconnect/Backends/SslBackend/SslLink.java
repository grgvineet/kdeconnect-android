...
public class SslLink extends BaseLink{
    ...
    public SslLink(Context context,IoSession session, String deviceId, BaseLinkProvider linkProvider) {
...
//        // refactor : setting private key
    ...
    public PairingHandler getNewPairingHandler(Device device) {
        return new SslPairingHandler(getContext(), device);
    }
