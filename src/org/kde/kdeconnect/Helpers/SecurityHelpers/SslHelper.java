...
public class SslHelper {
    ...
    public static SslFilter getSslFilter(final Context context, final String deviceId, SslMode sslMode) {
    ...
    // TODO : Rmeove this method, and use the above one, since it trusts all certificates
